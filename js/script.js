(function ($) {
  ...
  window.onload = function () {
    ...
    parallaxBox.onmousemove = function (event) {
      ...
      mouseParallax(
        "l2",
        c2left * offsetpercentX,
        c2top * offsetpercentY,
        x,
        y,
        25,
      );
      mouseParallax(
        "l3",
        c3left * offsetpercentX,
        c3top * offsetpercentY,
        x,
        y,
        20,
      );
      mouseParallax(
        "l4",
        c4left * offsetpercentX,
        c4top * offsetpercentY,
        x,
        y,
        35,
      );
      mouseParallax(
        "l5",
        c5left * offsetpercentX,
        c5top * offsetpercentY,
        x,
        y,
        30,
      );
      mouseParallax(
        "l6",
        c6left * offsetpercentX,
        c6top * offsetpercentY,
        x,
        y,
        45,
      );
      mouseParallax(
        "l7",
        c7left * offsetpercentX,
        c7top * offsetpercentY,
        x,
        y,
        30,
      );
      mouseParallax(
        "l8",
        c8left * offsetpercentX,
        c8top * offsetpercentY,
        x,
        y,
        25,
      );
      mouseParallax(
        "l9",
        c9left * offsetpercentX,
        c9top * offsetpercentY,
        x,
        y,
        40,
      );
